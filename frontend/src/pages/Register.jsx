...
/* import {register, reset} from '../features' */
        ...
        <>
            ...
            <section className="form">
                <form onSubmit={onSubmit}>
                    ...
                    <div className="form-group">
                        <input type="password" className="form-control" id="password2" email="password2" value={password2} placeholder="Confirm password" onchange={onChange} />
                    </div>
                    <div className="form-group">
